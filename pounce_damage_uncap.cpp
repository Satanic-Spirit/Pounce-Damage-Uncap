...
ConVar z_pounce_damage_range_min("z_pounce_damage_range_min", "50.0", FCVAR_GAMEDLL|FCVAR_CHEAT, "Minimum range for a pounce to be worth bonus damage.", true, 0.0, false, 0.0, min_range_changed);
